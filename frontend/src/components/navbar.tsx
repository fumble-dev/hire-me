                    ...
                    <Popover>
                        ...
                        <PopoverContent className='w-56 p-2' align='end'>
                            <div className='px-3 py-2 mb-2 border-b'>
                                ...
                                <p className="text-sm opacity-60 truncate">udanth@gmail.com</p>
                            </div>
                            ...
                            <Button className='w-ful justify-start gap-2 mt-1' variant={'ghost'} onClick={logoutHandler}>
                ...
                <div className='px-3 py-3 space-y-1 bg-background/95 backdrop-blur-md'>
                    ...
                    <div>
...

                        {
                            ...
                            <Button variant={'destructive'} className='w-full justify-start gap-3 h-11' onClick={()=>{toggleMenu();logoutHandler();}}>
